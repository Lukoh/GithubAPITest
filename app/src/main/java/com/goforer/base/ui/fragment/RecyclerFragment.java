/*
 * Copyright (C) 2016 Lukoh Nam(남걸호), goForer
 *
...
public abstract class RecyclerFragment<T> extends BaseFragment {
    ...
    private static class handleTask extends AsyncTask<Void, Void, List> {
        ...
        protected List doInBackground(Void... params) {
            return mFragment.parseItems(mEvent.getResponseClient().getPhotos());
        }
        ...
        protected void onPostExecute(List items) {
            ...
            if (fragment != null) {
                if (items.size() == 0) {
                    Toast.makeText(mFragment.getContext(), R.string.toast_no_photo,
